...
<Important>
    <ul>
        ...
        <li>The complete and assembled model is for demonstration purposes and <u>should not</u> be 3D printed. Instead, 3D print the individual parts, which are available below. Alternatively, you can <a class="text-purple-800" href="https://github.com/zlaast/ATH-M40X">visit the repo here</a></li>
        <li>Please see the warning below on printing the Pivot</li>
    </ul>
</Important>
