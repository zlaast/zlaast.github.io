...
![Not Internal](/images/posts/nand2tetris/Project%201/Not-internal.png)

And the following image shows how a **NOT** gate is represented in schematics:
![Not](/images/posts/nand2tetris/Project%201/Not.png)

The code below is the implementation of a **NOT** gate using a **NAND** gate.

<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/Not.hdl" group="1" name="NOT.hdl" checked="checked">
```
CHIP Not {
    IN in;
    OUT out;
...
![And Internal](/images/posts/nand2tetris/Project%201/And-internal.png)

And below is how an **AND** gate is normally represented in schematics
![And](/images/posts/nand2tetris/Project%201/And.png)

And finally the HDL implementation

<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/And.hdl" group="2" name="And.hdl" checked="checked">
```
CHIP And {
IN a, b;
OUT out;
...
![Or Internal](/images/posts/nand2tetris/Project%201/Or-internal.png)

The normal schematic representation of an OR gate is shown below
![Or](/images/posts/nand2tetris/Project%201/Or.png)

And finally the pertaining code

<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/Or.hdl" group="3" name="Or.hdl"checked="checked">
```
...
![Xor Internal](/images/posts/nand2tetris/Project%201/XOR-internal.png)

As usual, the schematic representation
![Xor](/images/posts/nand2tetris/Project%201/XOR.png)

And finally the code

<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/Xor.hdl" group="4" name="Xor.hdl" checked="checked">
```
CHIP Xor {
IN a, b;
OUT out;
...
![Mux Internal](/images/posts/nand2tetris/Project%201/Mux-internal.png)
...
![Mux](/images/posts/nand2tetris/Project%201/Mux.png)

And the code

<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/Mux.hdl" group="5" name="Mux.hdl" checked="checked">
```
CHIP Mux {
IN a, b, sel;
OUT out;
...
![Dmux Internal](/images/posts/nand2tetris/Project%201/DMux-internal.png)
...
![Dmux](/images/posts/nand2tetris/Project%201/DMux.png)

<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/DMux.hdl" group="6" name="DMux.hdl" checked="checked">
```
CHIP DMux {
IN in, sel;
OUT a, b;
...
<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/Not16.hdl" group="7" name="Not16.hdl" checked="checked">
```
CHIP Not16 {
IN in[16];
OUT out[16];
...
<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/And16.hdl" group="8" name="And16.hdl" checked="checked">
```
CHIP And16 {
IN a[16], b[16];
OUT out[16];
...
<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/Or16.hdl" group="9" name="Or16.hdl" checked="checked">
```
CHIP Or16 {
IN a[16], b[16];
OUT out[16];
...
<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/Mux16.hdl" group="10" name="Mux16.hdl" checked="checked">
```
CHIP Mux16 {
IN a[16], b[16], sel;
OUT out[16];
...
![Mux4Way16](/images/posts/nand2tetris/Project%201/Mux4Way16.png)
...
<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/Mux4Way16.hdl" group="11" name="Mux4Way16.hdl" checked="checked">
```
CHIP Mux4Way16 {
...
![Mux8Way16](/images/posts/nand2tetris/Project%201/Mux8Way16.png)

<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/Mux8Way16.hdl" group="12" name="Mux8Way16.hdl" checked="checked">
```
CHIP Mux8Way16 {
...
![Dmux4Way](/images/posts/nand2tetris/Project%201/DMux4Way.png)

<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/DMux4Way.hdl" group="13" name="DMux4Way.hdl" checked="checked">
```
CHIP DMux4Way {
IN in, sel[2];
OUT a, b, c, d;
...
![Dmux8Way](/images/posts/nand2tetris/Project%201/DMux8Way.png)

<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/DMux8Way.hdl" group="14" name="DMux8Way.hdl" checked="checked">
```
CHIP DMux8Way {
IN in, sel[3];
OUT a, b, c, d, e, f, g, h;
...
![Or8Way](/images/posts/nand2tetris/Project%201/Or8Way.png)

<Tab url="https://github.com/zlaast/nand2tetris/blob/main/nand2tetris%20-%20Part%201/01/Or8Way.hdl" group="15" name="Or8Way.hdl" checked="checked">
```
CHIP Or8Way {
IN in[8];
OUT out;
