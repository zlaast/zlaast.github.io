...
image: "/images/posts/nand2tetris/nand2tetris.png"
excerpt: "In an effort to design a simple computer from the ground up, we need to create the relevant hardware to make such a machine work."
read_time: 10
---
...
<Gallery src="/images/posts/nand2tetris/project-1/Not-internal.png" alt="Not internal" />

And the following image shows how a **NOT** gate is represented in schematics:
<Gallery src="/images/posts/nand2tetris/project-1/Not.png" alt="Not" />

The code below is the implementation of a **NOT** gate using a **NAND** gate.

<Tabs>
<Tab name="NOT.hdl" checked="checked" group="1">
```
CHIP Not {
    IN in;
    OUT out;
...
<Gallery src="/images/posts/nand2tetris/project-1/And-internal.png" alt="And internal" />

And below is how an **AND** gate is normally represented in schematics
<Gallery src="/images/posts/nand2tetris/project-1/And.png" alt="And" />

And finally the HDL implementation

<Tabs>
<Tab name="And.hdl" checked="checked" group="2">
```
CHIP And {
IN a, b;
OUT out;
...
<div class="text-center py-3">$$ \overline{A \land B} = \overline{A} \lor \overline{B} $$</div>
<div class="caption italic text-center">Equation - De Morgan's Theorem</div>

Note that
1.  ∧ means logical **AND**
2.  ∨ means logical **OR**
3.  $$\overline{x} $$ means logical **NOT** (in this case, **NOT** x)
...
<div class="text-center py-3">$$ \overline{\overline{A} \land \overline{B}} = \overline{\overline{A \lor B}} = A \lor B $$</div>

The above boolean equation is demonstrated by the schematic below
<Gallery src="/images/posts/nand2tetris/project-1/Or-internal.png" alt="Or internal" />

The normal schematic representation of an OR gate is shown below
<Gallery src="/images/posts/nand2tetris/project-1/Or.png" alt="Or" />

And finally the pertaining code

<Tabs>
<Tab name="Or.hdl" checked="checked" group="3">
```
CHIP Or {
IN a, b;
OUT out;
...
<div class="text-center py-3">$$ (\overline A \land B) \lor (A \land \overline B) $$</div>
...
<Gallery src="/images/posts/nand2tetris/project-1/XOR-internal.png" alt="Xor Internal" />

As usual, the schematic representation
<Gallery src="/images/posts/nand2tetris/project-1/XOR.png" alt="XOR" />

And finally the code

<Tabs>
<Tab name="Xor.hdl" checked="checked" group="4">
```
CHIP Xor {
IN a, b;
OUT out;
...
<Gallery src="/images/posts/nand2tetris/project-1/Mux-internal.png" alt="Mux internal" />
...
<Gallery src="/images/posts/nand2tetris/project-1/Mux.png" alt="Mux" />

And the code
<Tabs>
<Tab name="Mux.hdl" checked="checked" group="5">
```
CHIP Mux {
IN a, b, sel;
OUT out;
...
<Gallery src="/images/posts/nand2tetris/project-1/DMux-internal.png" alt="DMux internal" />
...
<Gallery src="/images/posts/nand2tetris/project-1/DMux.png" alt="DMux" />

<Tabs>
<Tab name="DMux.hdl" checked="checked" group="6">
```
CHIP DMux {
IN in, sel;
OUT a, b;
...
<Tabs>
<Tab name="Not16.hdl" checked="checked" group="7">
```
CHIP Not16 {
IN in[16];
OUT out[16];
...
<Tabs>
<Tab name="And16.hdl" checked="checked" group="8">
```
CHIP And16 {
IN a[16], b[16];
OUT out[16];
...
<Tabs>
<Tab name="Or16.hdl" checked="checked" group="9">
```
CHIP Or16 {
IN a[16], b[16];
OUT out[16];
...
<Tabs>
<Tab name="Mux16.hdl" checked="checked" group="10">
```
CHIP Mux16 {
IN a[16], b[16], sel;
OUT out[16];
...
<Gallery src="/images/posts/nand2tetris/project-1/Mux4Way16.png" alt="Mux4Way16" />
...
<Tabs>
<Tab name="Mux4Way16.hdl" checked="checked" group="11">
```
CHIP Mux4Way16 {
...
<Gallery src="/images/posts/nand2tetris/project-1/Mux8Way16.png" alt="Mux8Way16" />
<Tabs>
<Tab name="Mux8Way16.hdl" checked="checked" group="12">
```
CHIP Mux8Way16 {
...
<Gallery src="/images/posts/nand2tetris/project-1/DMux4Way.png" alt="DMux4Way" />

<Tabs>
<Tab name="DMux4Way.hdl" checked="checked" group="13">
```
CHIP DMux4Way {
IN in, sel[2];
OUT a, b, c, d;
...
<Gallery src="/images/posts/nand2tetris/project-1/DMux8Way.png" alt="DMux8Way" />

<Tabs>
<Tab name="DMux8Way.hdl" checked="checked" group="14">
```
CHIP DMux8Way {
IN in, sel[3];
OUT a, b, c, d, e, f, g, h;
...
<Gallery src="/images/posts/nand2tetris/project-1/Or8Way.png" alt="Or8Way" />

<Tabs>
<Tab name="Or8Way.hdl" checked="checked" group="15">
```
CHIP Or8Way {
IN in[8];
OUT out;
