...
excerpt: "Here, we create the memory modules for the computer."
read_time: 5
---
...
<Gallery src="/images/posts/nand2tetris/project-3/bit.png" alt="bit" />
...
<Tabs>
<Tab name="Bit.hdl" checked="checked" group="1">
```
CHIP Bit {
    IN in, load;
    OUT out;
...
<Tabs>
<Tab name="Register.hdl" checked="checked" group="2">
```
CHIP Register {
    IN in[16], load;
    OUT out[16];
...
<Gallery src="/images/posts/nand2tetris/project-3/PC.png" alt="PC" />
...
<Tabs>
<Tab name="PC.hdl" checked="checked" group="3">
```
CHIP PC {
...
<Gallery src="/images/posts/nand2tetris/project-3/RAM8.png" alt="RAM8" />

<Tabs>
<Tab name="RAM8.hdl" checked="checked" group="4">
```
CHIP RAM8 {
...
<Tabs>
<Tab name="RAM64.hdl" checked="checked" group="5">
```
CHIP RAM64 {
...
### RAM512
<Tabs>
<Tab name="RAM512.hdl" checked="checked" group="6">
```
CHIP RAM512 {
...
### RAM4k
<Tabs>
<Tab name="RAM4k.hdl" checked="checked" group="7">
```
CHIP RAM4K {
...
<Tabs>
<Tab name="RAM16k.hdl" checked="checked" group="8">
```
CHIP RAM16K {
