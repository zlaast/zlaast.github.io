...
excerpt: "The solution here may not be the most efficient, but it works. The program loops through all 3-digit number products, converts them to a string, reverses the string, and then checks if the reversed and unreversed strings are equivalent."
read_time: 1
---
