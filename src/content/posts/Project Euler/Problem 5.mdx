...
- <Math equation="2 = 2" />
- <Math equation="3 = 3" />
- <Math equation="4 = 2 \times 2" />
- <Math equation="5 = 5" />
- <Math equation="6 = 2 \times 3" />
- <Math equation="7 = 7" />
- <Math equation="8 = 2 \times 2 \times 2" />
- <Math equation="9 = 3 \times 3" />
- <Math equation="10 = 2 \times 5" />
...
<Math inline="false" equation="1 \times 2 \times 3 \times 2 \times 5 \times 7 \times 2 \times 3 = 2520" />
...
<Tabs list={
    [
        {
            "tab": "problem05.py",
            "url": "https://github.com/zlaast/Project-Euler/blob/main/Problems%20%5B1-100)/problem05.py"
        },
        {
            "tab": "main.rs",
            "url": "https://github.com/zlaast/Project-Euler/blob/main/Problems%20-%20Rust/problem_5/src/main.rs"
        },
    ]
}>
