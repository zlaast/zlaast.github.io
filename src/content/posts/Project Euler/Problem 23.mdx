...
excerpt: "Phew, this problem is more involved than others, but manageable. Here are the steps I took to solve it."
read_time: 5
---
...
which was explained in a [previous post](/posts/project-euler/problem-21).
