...
image: "/images/posts/tryhackme/hammer/hammer.png"
...
<Gallery src="/images/posts/tryhackme/hammer/leet.gif" caption="Caption: If you understand 1337, your knees probably hurt 👴" alt="Kinda old tbh" />
...
<Important>You have to manually cancel the script after you have successfully bruteforced an OTP. I tried to set up conditions to automatically end the script on success but they didn't work. It is what it is. 🤷</Important>
...
<Gallery src="/images/posts/tryhackme/hammer/magic_word.gif" alt="It's not magic" caption="Caption: The only magic word allowed is 'ls' ☹️ " />
...
Hmmmm 🤔. There's a `kid` field in the header, and it references a key! When the token looks to verify the signature, it will look for the key listed here. But we *have* a key, so we can modify
